...
public class Main {
	...
	public static void main(String[] args) {
		...
		PacienteFullDTO pacienteFullDTO = new PacienteFullDTO("João Silva", "123.456.789-00", LocalDate.of(2000, 3, 25),
				11987654321L, 1132109876L, "joao@example.com", EnumGenero.MASCULINO, 123456, "SP", "São Paulo",
				"Centro", "Rua A", "100", "Apt 101", 1.75f, false, false, 987654321, "Saúde Plena", "Plano Premium",
				"Nenhum", "Paracetamol", "Tomar 1 vez ao dia");

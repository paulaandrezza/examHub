...
public class EditarEnderecoPanel extends JPanel {
	...
	public EditarEnderecoPanel(PacienteController pacienteController, PacienteFullDTO pacienteFullDTO,
			EditarPanel cadastroPanel) {
